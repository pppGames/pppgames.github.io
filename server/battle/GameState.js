...
// Load Data
const atkDataRaw = require("../data/atk_data.json");
const memDataRaw = require("../data/mem_data.json");
const leaderDataRaw = require("../data/leader_data.json");
const tacticsDataRaw = require("../data/tactics_data.json");
...
class GameState {
    ...
    processEffectString(playerId, key, context = {}, card = null) {
        ...
        const { executeEffect } = require('./effects');
    ...
    resolveAction(playerId, actionData) {
        ...
        if (pending.type === "SELECT_EFFECT_TARGET") {
            ...
            const p = this.players[playerId]; // Ensure we target the player who owns the pending action (Awakening is self)
