 ...
 */
function handleDrawAll(gameState, playerId) {
 ...
 */
function handleDrawDiscard(drawCount, discardCount) {
    return (gameState, playerId) => {
 ...
 */
function handleCascade(gameState, playerId) {
 ...
 */
function handleDrawIfDown(gameState, playerId, context) {
